<?php
	...
	if(isset($_POST['email'])&&isset($_POST['num_row']))
	{
		...
		$result = pg_query($db,"SELECT * FROM temp_prescription  order by time_stamp desc ;");
		$arr = pg_fetch_all($result);
		$num_rows = pg_num_rows($result);
		$body = "<div class=\"panel panel-default\">
				   <div class=\"panel-heading\" role=\"tab\" id=\"heading%d\">
				      <h4 class=\"panel-title\">
				         <a %s data-toggle=\"collapse\"  href=\"#collapse%d\" aria-expanded=\"%s\" aria-controls=\"collapse%d\">
				         Prescription #%d
				         </a>
				      </h4>
				   </div>
				   <div id=\"collapse%d\" class=\"panel-collapse collapse %s\" role=\"tabpanel\" aria-labelledby=\"heading%d\">
				    ...
				    <div class='row'>
						...
						<div class='col-md-4'>
							...
							<div class='row'>
								<button  type=\"button\" value=\"%s;%s;%s;%s;%s;%s\" onclick=\"return confirm_patient(this.value);\" class=\"%s\">%s</button>
							</div>

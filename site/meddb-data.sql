...
insert into prescription values ('vipina82@gmail.com', 'adityaa@iitrpr.ac.in', 'anshumany@iitrpr.ac.in', '2014-01-10 09:06:10', 'Beta testing', NULL);
insert into Prescription values ('agams@iitrpr.ac.in','vipina@iitrpr.ac.in','ankitkhokhar@iitrpr.ac.in','2015-04-11','Star Wars',null);
insert into Prescription values ('agams@iitrpr.ac.in','adityaa@iitrpr.ac.in','anshumany@iitrpr.ac.in','2015-03-12','Game of Thrones',null);
insert into Prescription values ('agams@iitrpr.ac.in','balwinder@iitrpr.ac.in','ankitkhokhar@iitrpr.ac.in','2014-12-31','Remove 5 teeth',null);